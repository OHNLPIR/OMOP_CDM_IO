...
/** Modified with performance fixes, search mod::perf */
...
//      List<EntityMention> entityMentions = JCasUtil.selectCovering(systemView, EntityMention.class, arg1.getBegin(), arg1.getEnd());
            ...
            CounterMap<String> typeCounts =
                    getMentionTypes(new LinkedList<>(index.getCovering(arg1.getBegin(), arg1.getEnd(), EventMention.class)));
...
//      }
        ...
        if(arg2 instanceof EventMention){
            // mod::perf
            CounterMap<String> typeCounts =
                    getMentionTypes(new LinkedList<>(index.getCovering(arg2.getBegin(), arg2.getEnd(), EventMention.class)));
