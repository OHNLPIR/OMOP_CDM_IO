...
/** Modified version from cTAKES for performance (search mod::perf) */
        ...
        public void process(JCas jcas) throws AnalysisEngineProcessException {
            ...
            for(EventMention mention : JCasUtil.select(jcas, EventMention.class)){
                ...
                if(mention.getClass().equals(EventMention.class)){
                    ...
                    for(EventMention covering : index.getCovering(mention.getBegin(), mention.getEnd(), EventMention.class)){
