...
//				JCasUtil.indexCovering(jCas, EventMention.class, EventMention.class);
        ...
        for (int i = 0; i < eventNum-1; i++){
            for(int j = i+1; j < eventNum; j++){
                ...
                // mod::perf
                for( EventMention aEve : index.getCovering(eventA.getBegin(), eventA.getEnd(), EventMention.class)){
                ...
                // mod::perf
                for( EventMention bEve : index.getCovering(eventB.getBegin(), eventB.getEnd(), EventMention.class)){
