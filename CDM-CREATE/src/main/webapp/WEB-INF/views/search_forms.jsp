<div class="tab-content" id="search-tabcontent">
    <div class="tab-pane fade in active" id="textqueryeditor" role="tabpanel"
        ...
        <div class="form-group">
                                       <textarea class="form-control" rows="20" name="textQuery" title="Query"
                                                 ng-model="CREATE.model.query.unstructured">
                                       </textarea>
        </div>
    </div>
    <div class="tab-pane fade" id="structurededitor" role="tabpanel"
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-3 text-left" ng-if="CREATE.structuredReferenceBar">
                ...
                <div ng-class="CREATE.structuredReferenceBar ? 'col-xs-9' : 'col-xs-12'"
                     ng-style="CREATE.structuredReferenceBar ? {'border-left': '1px solid #e5e5e5'} : {}">
                    <div class="panel panel-default"
                         ng-repeat="rType in CREATE.mappings.structOptions">
                        ...
                        <div class="panel-body text-left">
                            <ul class="list-unstyled">
                                <li
                                        ng-repeat="clause in CREATE.model.query.structured track by $index"
                                        ng-show="clause.recordType === rType"
                                        ng-init="clauseIdx = $index">
                                    <div class="input-group col-xs-12">
                                        <select class="input-small"
                                                ng-model="CREATE.model.query.structured[clauseIdx].type"
                                                title="filter">
                                            <option ng-repeat="type in CREATE.CLAUSE_TYPES"
                                                    value="{{type}}">{{type}}
                                            </option>
                                        </select>
                                        <select class="input-small"
                                                ng-model="CREATE.model.query.structured[clauseIdx].field"
                                                title="field">
                                            <option value="" disabled selected hidden>Choose
                                                a
                                                Field...
                                            </option>
                                            <option ng-repeat="(field, ignored) in CREATE.mappings.mappings[rType].properties"
                                                    value="{{field}}">{{field}}
                                            </option>
                                        </select>
                                        <!-- TODO do fancy stuff with input types here -->
                                        <input type="text" class="input-small"
                                               ng-model="CREATE.model.query.structured[clauseIdx].content"
                                               title="content" placeholder="Search Query"/>
                                        <div class="btn-group" style="padding-left: 5px;">
                                            <button type="button" class="btn btn-secondary"
                                                    ng-click="CREATE.model.query.addStructuredItem(rType);">
                                                &plus;
                                            </button>
                                            <button type="button" class="btn btn-secondary"
                                                    ng-click="CREATE.model.query.removeStructuredItem($index)">
                                                &minus;
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div ng-if="(CREATE.model.query.structured | filter: {recordType: rType}).length === 0">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <button type="button" class="btn btn-default pull-left"
                            ng-click="CREATE.structuredReferenceBar = !CREATE.structuredReferenceBar">
                        {{!CREATE.structuredReferenceBar ? "Show" : "Hide"}} Query Syntax Reference
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="tab-pane fade" id="cdmeditor" role="tabpanel"
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="form-group">
                    <p ng-if="CREATE.model.query.cdmQuery.length == 0">No currently used CDM objects: add a text query or add a CDM object to get started</p>
                    <!-- Render the output objects-->
                    <ul style="padding-left: 20px;">
                        <li class="cdm_object_editable_container"
                            ng-repeat="cdm_object in CREATE.model.query.cdmQuery track by $index"
                                        ...
                                        <div class="cdm_field_content">
                                            <label>
                                                ...
                                                <input type="text" class="cdm_field_content_editable"
                                                       ng-model="CREATE.model.query.cdmQuery[objectIdx][field]"/>
                                            </label>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="cdm_object_remove pull-right">
                                <span ng-click="CREATE.model.query.removeCDMItem($index)">&times;</span>
                            </div>
                        </li>
                    </ul>
                    <div class="clearfix"></div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <button type="button" class="btn btn-default pull-left"
                        ng-click="CREATE.refresh(true);">Reset
                    from Text Query
                </button>
                <div class="dropdown pull-left" style="padding-left: 3px;">
                    ...
                    <ul class="dropdown-menu">
                        <li ng-repeat="item in CREATE.mappings.cdmOptions">
                            <a href="#"
                               ng-click="CREATE.model.query.newCDM(CREATE.mappings, item)">{{item}}</a>
                        </li>
                    </ul>
                </div>
            </div>
