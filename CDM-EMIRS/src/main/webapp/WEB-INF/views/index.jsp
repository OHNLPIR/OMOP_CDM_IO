                ...
                <div class="container">
                    <div>
                        ...
                        <form name="search" ng-submit="EMIRS.submitQuery()">
                            <label>
                                Query
                                <input type="text" title="Query" ng-model="EMIRS.model.query.unstructured"/>
                            </label>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <ul>
                                                <li class="cdm_object_editable_container" ng-repeat="cdm_object in EMIRS.model.query.cdmQuery">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default pull-left" ng-click="alert(EMIRS.model.query.cdmQuery)">Reset
                                                from Text Query
                                            </button>
                                            <button type="button" class="btn btn-default pull-left" ng-click="EMIRS.model.query.resetSoft()">Reset to
                                                Last Executed
                                            </button>
