...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item active">
        <a class="nav-link" id="text-tab" data-toggle="tab" href="#textqueryeditor"
           role="tab" aria-controls="textqueryeditor" aria-selected="true">Text</a></li>
    <li class="nav-item">
        <a class="nav-link" id="structured-tab" data-toggle="tab" href="#structurededitor"
           role="tab" aria-controls="structurededitor" aria-selected="false">Structured Data</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="cdm-tab" data-toggle="tab"
           href="#cdmeditor" role="tab" aria-controls="cdmeditor"
           aria-selected="false">OHDSI CDM Objects</a>
    </li>
</ul>
<!-- Content|Editors -->
<div class="row">
