    ...
    this.submit = function ($http, model, filter) {
        $http.post('/_search', {
            ...
            if (resp.data != null) {
                ...
                model.hits = resp.data.docPager.docs;
                model.currentPage = resp.data.docPager.currPage;
                model.pageSize = resp.data.docPager.pageSize;
                model.numHits = resp.data.docPager.numHits;
